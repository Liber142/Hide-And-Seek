...
private:
	...
	int m_CountingTime; // TODO: move to Config();
	int m_SeekerId = -1; //TODO: I future we need one more seekers
	
	int m_StartWaitingTick;
	int m_WaitingTime; // TODO: move to Config();
	void StartRound();
	void EndRound();
	bool DoEndRound();
